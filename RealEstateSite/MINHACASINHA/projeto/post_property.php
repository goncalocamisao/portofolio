...
if(isset($_POST['post'])){
   ...
   if($image_01_size > 2000000){
      ...
      $success_msg[] = 'Propriedade publicada com sucesso!';
   }
...
<head>
   ...
   <title>Publicar Propriedade</title>
...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="box">
         ...
         <input type="text" name="property_name" required maxlength="50" placeholder="Insira o nome da propriedade" class="input">
      </div>
      <div class="flex">
         <div class="box">
            <p>Preço da propriedade <span>*</span></p>
            <input type="number" name="price" required min="0" max="9999999999" maxlength="10" placeholder="Insira o preço da propriedade" class="input">
         </div>
         <div class="box">
            <p>Tamanho do depósito <span>*</span></p>
            <input type="number" name="deposite" required min="0" max="9999999999" maxlength="10" placeholder="Insira a quantia de depósito" class="input">
         </div>
         <div class="box">
            <p>Endereço da propriedade <span>*</span></p>
            <input type="text" name="address" required maxlength="100" placeholder="Insira o endereço completo da propriedade" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            <p>Quantas BHK (Quartos, Entradas, Cozinhas) <span>*</span></p>
         ...
         <div class="box">
            <p>Área do Chão <span>*</span></p>
            <input type="number" name="carpet" required min="1" max="9999999999" maxlength="10" placeholder="Quantos metros quadrados?" class="input">
         </div>
         <div class="box">
            <p>Idade da propriedade <span>*</span></p>
            <input type="number" name="age" required min="0" max="99" maxlength="2" placeholder="Qual é a idade da propriedade?" class="input">
         </div>
         <div class="box">
            <p>Quantidade de Andares? <span>*</span></p>
            <input type="number" name="total_floors" required min="0" max="99" maxlength="2" placeholder="Quantos andares disponíveis?" class="input">
         </div>
         <div class="box">
            <p>Andar <span>*</span></p>
            <input type="number" name="room_floor" required min="0" max="99" maxlength="2" placeholder="Andar da propriedade" class="input">
         </div>
         <div class="box">
      ...
      <div class="checkbox">
         <div class="box">
            <p><input type="checkbox" name="lift" value="yes" />Elevadores</p>
            <p><input type="checkbox" name="security_guard" value="yes" />Guarda de Segurança</p>
            <p><input type="checkbox" name="play_ground" value="yes" />Parque</p>
            <p><input type="checkbox" name="garden" value="yes" />Jardim</p>
            <p><input type="checkbox" name="water_supply" value="yes" />Abastecimento de Água</p>
            <p><input type="checkbox" name="power_backup" value="yes" />Backup de Energia</p>
         </div>
         <div class="box">
            <p><input type="checkbox" name="parking_area" value="yes" />Área de estacionamento</p>
            <p><input type="checkbox" name="gym" value="yes" />Ginásio</p>
            ...
            <p><input type="checkbox" name="school" value="yes" />Escola</p>
            <p><input type="checkbox" name="market_area" value="yes" />Área de mercado</p>
         </div>
      </div>
      <div class="box">
      ...
      <input type="submit" value="Publicar propriedade" class="btn" name="post">
   </form>
