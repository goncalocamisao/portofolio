...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <h3>Pesquisa filtrada</h3>
         <p>Procura a tua propriedade de sonho!</p>
         <a href="search.php" class="btn">Procura agora</a>
      </div>
      ...
      <a href="my_listings.php" class="btn">Ver todas listadas</a>
      </div>
      ...
      <a href="requests.php" class="btn">Ver todas as solicitações</a>
      </div>
      ...
      <p>Solicitações Envidadas</p>
      <a href="saved.php" class="btn">Ver todas as propriedades salvas</a>
      </div>
