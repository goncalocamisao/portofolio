...
<section class="filters" style="padding-bottom: 0;">
   ...
   <form action="" method="post">
      ...
      <h3>Filtra a tua pesquisa</h3>
         
         <div class="flex">
            <div class="box">
               <p>Colocar localização</p>
               <input type="text" name="location" required maxlength="50" placeholder="Insira a cidade" class="input">
            </div>
            <div class="box">
               <p>Tipo de oferta</p>
            ...
            <div class="box">
               <p>Quantas BHK (Quartos, Entradas, Cozinhas)</p>
         ...
         <input type="submit" value="Procurar Propriedade" name="filter_search" class="btn">
   </form>
...
<section class="listings">
   ...
   <?php 
      if(isset($_POST['h_search']) or isset($_POST['filter_search'])){
         echo '<h1 class="heading">Resultados da pesquisa</h1>';
      }else{
         echo '<h1 class="heading">Últimas listagens</h1>';
      }
   ?>
   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         <div class="box">
            ...
            ?>
            <button type="submit" name="save" class="save"><i class="fas fa-heart"></i><span>Salvo</span></button>
            <?php
               }else{ 
            ?>
         ...
         <div class="box">
            ...
            <div class="flex">
               ...
               <p><i class="fas fa-maximize"></i><span><?= $fetch_property['carpet']; ?>Metro Quadrado/s</span></p>
            </div>
            <div class="flex-btn">
      ...
      <?php
         ...
         echo '<p class="empty">Não foram encontrados resultados!</p>';
      }
      ?>
