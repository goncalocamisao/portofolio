...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Mensagem removida!';
   }else{
      $warning_msg[] = 'Mesnsagem já foi removida!';
   }
...
<section class="grid">
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <input type="submit" value="Remover mensagem" onclick="return confirm('Remover esta mensagem?');" name="delete" class="delete-btn">
      </form>
   </div>
   <?php
      }
