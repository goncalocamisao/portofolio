...
<section class="listings">
   ...
   <h1 class="heading">Todas as listagens</h1>

   <form action="" method="POST" class="search-form">
      <input type="text" name="search_box" placeholder="Procurar Listagens..." maxlength="100" required>
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <a href="view_property.php?get_id=<?= $listing_id; ?>" class="btn">Ver propriedade</a>
         <input type="submit" value="Remover esta Listagem" onclick="return confirm('Remover esta listagem?');" name="delete" class="delete-btn">
      </form>
   </div>
   <?php
         }
         ...
         echo '<p class="empty">Sem propriedades adicionadas ainda!</p>';
      }
   ?>
