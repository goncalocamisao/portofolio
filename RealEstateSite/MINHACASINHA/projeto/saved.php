...
<section class="listings">
   ...
   <h1 class="heading">Listagens Salvas</h1>
   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         <div class="box">
            ...
            ?>
            <button type="submit" name="save" class="save"><i class="fas fa-heart"></i><span>Remover de Salva</span></button>
            <?php
               }else{ 
            ?>
      ...
      <?php
         ...
         echo '<p class="empty">Sem propriedades adicionadas ainda! <a href="listings.php" style="margin-top:1.5rem;" class="btn">Descubra mais!</a></p>';
      }
      ?>
