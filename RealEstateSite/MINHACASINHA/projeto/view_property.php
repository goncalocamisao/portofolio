...
<section class="view-property">
     ...
     <div class="swiper images-container">
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i class="fas fa-<?php if($fetch_property['power_backup'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>Abastecimento de Energia</span></p>
         </div>
         <div class="box">
   ...
   <?php
      ...
      echo '<p class="empty">property not found! <a href="post_property.php" style="margin-top:1.5rem;" class="btn">Adicionar nova</a></p>';
   }
   ?>
