...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Listagem removida com sucesso!';
   }else{
...
<head>
   ...
   <title>As minhas listagens</title>
...
<section class="my-listings">
   ...
   <h1 class="heading">As minhas listagens</h1>
   ...
   <form accept="" method="POST" class="box">
      ...
      <div class="flex-btn">
         <a href="update_property.php?get_id=<?= $property_id; ?>" class="btn">Atualizar</a>
         <input type="submit" name="delete" value="Remover" class="btn" onclick="return confirm('Remover esta listagem?');">
      </div>
      <a href="view_property.php?get_id=<?= $property_id; ?>" class="btn">Ver propriedade</a>
   </form>
   <?php
         }
      }else{
